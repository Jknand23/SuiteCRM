# AOR_Fields English Language Strings Documentation

**@fileoverview** English language localization strings for the Advanced OpenReports Fields module. Provides user-facing labels, messages, and interface text for field configuration and report output management functionality.
...
The `en_us.lang.php` file defines English language strings used throughout the AOR_Fields module interface. These strings support internationalization efforts and provide consistent labeling across all field configuration screens, report building forms, and output management interfaces.
...
#### Core Entity Labels
- **LBL_MODULE_NAME**: "Fields" - Primary module identifier
- **LBL_MODULE_TITLE**: "Fields" - Module title for navigation and headers
- **LBL_HOMEPAGE_TITLE**: "My Fields" - Personal dashboard title
- **LBL_LIST_FORM_TITLE**: "Fields List" - List view page title
- **LBL_NEW_FORM_TITLE**: "New Fields" - Create form title
- **LBL_SEARCH_FORM_TITLE**: "Search Fields" - Search interface title

#### Navigation and Action Labels
- **LNK_NEW_RECORD**: "Create Fields" - Link text for creating new fields
- **LNK_LIST**: "View Fields" - Link text for viewing field lists
...
#### Core Field Selection Labels
- **LBL_MODULE_PATH**: "Module" - Label for module path selection
- **LBL_FIELD**: "Field" - Label for field selection dropdown
- **LBL_LABEL**: "Label" - Label for custom field display name
- **LBL_ORDER**: "Order" - Label for field display order

#### Display Control Labels
- **LBL_DISPLAY**: "Display" - Label for field visibility checkbox
- **LBL_LINK**: "Link" - Label for clickable field link checkbox
- **LBL_FORMAT**: "Format Options" - Label for field formatting selection

#### Processing and Function Labels
- **LBL_FUNCTION**: "Function" - Label for database function selection
- **LBL_TOTAL**: "Total" - Label for aggregation function selection

### Sorting and Grouping Labels

#### Sort Configuration Labels
- **LBL_SORT**: "Sort" - Label for sort criteria selection
- **LBL_SORT_ORDER**: "Sort Order" - Label for sort direction selection

#### Grouping Configuration Labels
- **LBL_GROUP**: "Group" - Label for grouping criteria checkbox
- **LBL_GROUP_ORDER**: "Group Order" - Label for group sort direction
- **LBL_GROUP_DISPLAY**: "Group Display" - Label for group display configuration
...
### Specialized Functionality Labels

#### Technical Configuration Labels
- **LBL_AUDIT_TABLE**: "Audit table" - Label for audit table configuration
...
- **Context Awareness**: Labels appropriate for field configuration contexts

### Field Configuration Context
- **Technical Accuracy**: Labels reflect precise field configuration concepts
- **User-Friendly Terms**: Technical concepts presented in accessible language
- **Workflow Integration**: Labels support logical field configuration workflow
...
- **Configuration Context**: Labels specifically designed for field setup workflows
- **Advanced Features**: Support for complex field configuration concepts
- **User Guidance**: Labels provide clear guidance for field configuration options

This language file provides comprehensive internationalization support for the AOR_Fields module while maintaining consistency with SuiteCRM conventions and supporting both administrative customization and developer extension. The labels enable intuitive field configuration workflows and professional report output management. 